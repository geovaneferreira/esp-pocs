...
class BLE: NSObject, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    private let serviceUUID =           CBUUID(string: "ab0828b1-198e-4351-b779-901fa0e0371e") // ESP32 UART Service
    private let characteristicUUIDTx =  CBUUID(string: "ab0828b1-198e-4351-b779-901fa0e0371e") // ESP32 UART TX (Property = Write without response)
    private let characteristicUUIDRx =  CBUUID(string: "ab0828b1-198e-4351-b779-901fa0e0371e") // ESP32 UART RX (Property = Read/Notify)
    ...
    func peripheral(_ peripheral: CBPeripheral, didUpdateValueFor characteristic: CBCharacteristic, error: Error?) {
        ...
        if characteristic == characteristicRX {
            ...
            if let value:String = NSString(data: characteristic.value!, encoding: String.Encoding.utf8.rawValue) as String? {
                delegate?.bleDidReceiveLine(line: value)
                // Process data
